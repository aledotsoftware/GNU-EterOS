 ...
 *
 * Gestión de interrupciones para x86_64 Long Mode.
...
#define IDT_GATE_USER_INT   0xEE    /* P=1, DPL=3, Interrupt Gate (para syscalls) */
...
/**
 * Frame de interrupción (pushado por la CPU al entrar en un ISR).
 */
