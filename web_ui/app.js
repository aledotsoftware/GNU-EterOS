...
function updateClock() {
    ...
    // ⚡ Bolt: Prevent redundant DOM updates if time (minute) hasn't changed.
    // We check clock.textContent to ensure we still update on initial load or if DOM was reset.
