...
### Fase 2.6: ACPI (Advanced Configuration and Power Interface) ✅
- [] **ACPI Parser:** Implementación de ACPI para detección de hardware (CPU, I/O APIC)
- [] **MADT (Multiple APIC Description Table):** Enumeración de CPUs y I/O APICs
- [] **CPU Detection:** Soporte para multicore (SMP)
- [] **I/O APIC Detection:** Soporte para I/O APICs (para vectores de interrupción)
