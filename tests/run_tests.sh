...
echo "---------------------------------------------------"
echo "Running bench_serial_simulation..."
gcc -D__ETEROS_HOST_TEST__ -Iinclude tests/mock_net.c tests/bench_serial_simulation.c kernel/string.c tests/vmm_map_page_mock.c tests/mock_pmm.c -o tests/bench_serial_simulation
./tests/bench_serial_simulation
rm tests/bench_serial_simulation

echo "---------------------------------------------------"
echo "Running bench_vga_clear..."
gcc -D__ETEROS_HOST_TEST__ -Iinclude tests/mock_net.c tests/bench_vga_clear.c kernel/string.c tests/vmm_map_page_mock.c tests/mock_pmm.c -o tests/bench_vga_clear
./tests/bench_vga_clear
rm tests/bench_vga_clear

echo "---------------------------------------------------"
echo "Running test_elf_truncation..."
gcc -D__ETEROS_HOST_TEST__ -Iinclude tests/mock_net.c tests/test_elf_truncation.c tests/vmm_map_page_mock.c tests/mock_pmm.c -o tests/test_elf_truncation
./tests/test_elf_truncation
rm tests/test_elf_truncation

echo "---------------------------------------------------"
echo "Running test_initrd_security..."
gcc -D__ETEROS_HOST_TEST__ -Iinclude tests/mock_net.c tests/test_initrd_security.c tests/vmm_map_page_mock.c tests/mock_pmm.c -o tests/test_initrd_security
./tests/test_initrd_security
rm tests/test_initrd_security

echo "---------------------------------------------------"
echo "Running test_lwip_socket..."
gcc -D__ETEROS_HOST_TEST__ -Iinclude tests/mock_net.c tests/test_lwip_socket.c tests/vmm_map_page_mock.c tests/mock_pmm.c -o tests/test_lwip_socket
./tests/test_lwip_socket
rm tests/test_lwip_socket

echo "---------------------------------------------------"
echo "Running test_vfs_path_splitting..."
gcc -D__ETEROS_HOST_TEST__ -Iinclude tests/mock_net.c tests/test_vfs_path_splitting.c tests/vmm_map_page_mock.c tests/mock_pmm.c -o tests/test_vfs_path_splitting
./tests/test_vfs_path_splitting
rm tests/test_vfs_path_splitting

echo "---------------------------------------------------"
echo "Running verify_memset_edge_cases..."
gcc -D__ETEROS_HOST_TEST__ -Iinclude tests/mock_net.c tests/verify_memset_edge_cases.c tests/vmm_map_page_mock.c tests/mock_pmm.c -o tests/verify_memset_edge_cases
