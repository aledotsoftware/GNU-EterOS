...
- Fix de glue / integración: Se aplicó fix en `userspace/Makefile` (añadiendo `libc/src/ctype.c`) y fix en `kernel/arch/x86_64/syscall.c` (añadiendo atributos unused a funciones timerfd). El sistema compila y bootea de forma limpia.
